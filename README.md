...
Active Record Replica is a very simple layer that inserts itself into the call chain whenever a replica is configured.
...
Using this observation Active Record Replica only needs to intercept calls to the known select apis: 
* select_all
* select_one
* select_rows
* select_value
...
See [.travis.yml](https://github.com/teespring/active_record_replica/blob/master/.travis.yml) for the list of tested Ruby platforms
